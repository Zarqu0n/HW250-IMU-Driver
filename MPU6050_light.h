...
#define MPU6050_ADDR                  0x68 // Can be change 0x78 if AD0 is connected to VCC
...
class MPU6050
{
  public:
    MPU6050(TwoWire& w);
    byte init(mpu6050_dps_t gyro_fs, mpu6050_range_t acc_range);//initialize
    ...
    void calcOffsets(bool is_calc_gyro=true, bool is_calc_acc=true); //TODO all directions (like pixhawk)
    ...
    // MPU CONFIG SETTER /
    void setGyroConfig(mpu6050_dps_t gyro_fs);
    void setAccConfig(mpu6050_range_t acc_range);
